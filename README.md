Resolução do exercício <b>Space Age</b> do site Exercism usando Ruby. Foi implmentada uma solução usando uma hash e condicionais, para fortalecer conceitos básicos da linguagem.
